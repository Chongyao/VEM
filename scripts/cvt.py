...
def generate_seeds(n_seeds, bounds):
    """生成初始种子点"""
    x_min, x_max, y_min, y_max, z_min, z_max = bounds
...
def generate_mesh(n_seeds=1000, n_iters=10, bounds=[-2.0,2.0,-0.5,0.5,-0.5,0.5], output_file="beam_cvt_final.vtu"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="beam.vtu")
    args = parser.parse_args()
    
    generate_mesh(n_seeds=args.n_seeds, n_iters=args.n_iters, output_file=args.output)